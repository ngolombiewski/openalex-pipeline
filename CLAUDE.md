...
- `docs/TECHSTACK.md` — approved tools and libraries

Before introducing any tool or library not already in use, consult `docs/TECHSTACK.md` or ask. Hard constraints: never `pip` (use `uv`), never pandas (use Polars).
